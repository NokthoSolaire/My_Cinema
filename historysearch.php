...
<body>
    ...
    <div class="searchbar">
        <form action="./historysearch.php" methode="GET" name="form">
            <!-- <input class="bar" type="text" name="movieID" placeholder="Movie"/> -->
            <input class="bar" type="datetime-local" name="dated" placeholder="Dated"/>
            <input class="button" type="submit" name="search" value="Search"/>
        </form>
        <div class="autoscroll">
            <?php
                foreach ($datedview  as $value){
                    echo "<p class='dated_film'>" . "Movie: " . $value['Movies'] . "<br>" . "Date of Projection: " . $value['Dated'] . "<br>". "</p>" . "<br>";
                }

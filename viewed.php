...
<body>
    ...
    <div class="searchbar">
        <form action="./viewed.php" methode="GET" name="form">
        ...
        <div class="autoscroll">
            ...
            foreach ($viewed as $value) {
                echo "<p class='viewed__film'>" . "Subs's ID: ".$value['User Number'] . "<br>" . "Viewed movie: " . $value['Viewed film'] . "<br>" . "Date: " . $value['Date'] . "<br>" . "</p>" . "<br>";
            }
            ?>
        </div>
    </div>
